                        ...
                        <div id="product{{$product->id}}">{{$product->id}}
                            <div class="col mb-5">
                                <div class="card h-100">
                                    <!-- Product image-->
                                    <img class="card-img-top product-image" src="/storage/product/{{$product->file_path}}" alt="Product Image">
                                    <!-- Product details-->
                ...
                <div class="container px-4 px-lg-5 mt-5">
                    <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        ...
                        <div class="col mb-5">
                            <div class="card h-100">
                                <!-- Product image-->
                                <img class="card-img-top product-image" src="{{ URL::asset("storage/product/{$product->file_path}") }}" />
                                <!-- Product details-->
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <!-- Product name-->
...
<script>
    ...
    $('#search-input').on('keyup', function() {
        ...
        if (query.trim() === '') {
            ...
            $.ajax({
                ...
                error: function(data) {
                    console.log('search-input error:' + data)
                }
            });
        }
    });
    ...
    function search_submit(id) {
        ...
        //console.log(id);
        console.log('search_submit function:' + id);
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log('search_submit success:' + data);
            ...
            error: function(data) {
                console.log('search_submitdata error:' + data)
            }
        });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(index, product) {
                    ...
                    console.log('search-submit error:' + data)
                    ...
                    '<img class="card-img-top product-image" src="/storage/product/' + data[0].file_path + '" alt="Product Image">' +

                    '<div class="card-body p-4">' +
                    '<div class="text-center">' +

                    '<h5 class="fw-bolder" id="name">' + data[0].name + '</h5>' +
                    ...
                    '<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">' +
                    '<div class="text-center"><button id="addToCart" class="btn btn-outline-dark mt-auto" name="' + data[0].id + '" onclick="getId(this.name), counter(), checkAuth()">Add to Cart</button></div>' +
                    ' </div>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
